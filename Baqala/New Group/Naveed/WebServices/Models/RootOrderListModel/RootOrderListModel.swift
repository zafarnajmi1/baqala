...
struct OrderInfoModel {
    ...
    static  var orderStatus: String!
    static  var orderDate: String!
    static  var totalProducts: String!
    static  var totalAmount: String!
}

class RootOrderListModel : NSObject, NSCoding, Mappable{
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? [OrderListDataModel]
