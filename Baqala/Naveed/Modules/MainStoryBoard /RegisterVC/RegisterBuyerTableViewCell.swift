...
class RegisterBuyerTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var genderButton: DLRadioButton! //male
    ...
    @IBOutlet weak var passowrdConfirm: UITextField!
    ...
    override func awakeFromNib() {
        ...
        self.genderButton.isSelected = true //default male selected
    ...
    fileprivate func loadLocalization() {
        ...
        self.passowrdConfirm.placeholder = "Confirm Password".localized
        
        let txtFields = [firstName, lastName, email, phone, address, password, passowrdConfirm] as [UITextField]
    ...
    private func reuquestToCreateUserAcount()  {
        ...
        let gender = genderButton.isSelected == true ? "male" : "female"
        ...
        let params = [
            ...
            "passwordConfirmation":self.passowrdConfirm.text!,
            "accountType": "buyer",
        ...
        UserManager.shared.createUserAccount(params: params) { (error, rootModel) in
    ...
    private func  formIsvalid() -> Bool {
        ...
        if (passowrdConfirm.text?.count)! < 4 {
            let msg = "Please enter valid confirm password".localized
            nvMessage.showError(title: title, body: msg)
            return false
        }
        
        if password.text != passowrdConfirm.text {
...
extension RegisterBuyerTableViewCell : UITextFieldDelegate {
...
extension RegisterBuyerTableViewCell: GMSPlacePickerViewControllerDelegate {
...
extension RegisterBuyerTableViewCell: CLLocationManagerDelegate {
