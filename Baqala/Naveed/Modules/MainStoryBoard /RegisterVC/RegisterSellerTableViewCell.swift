//
//  RegisterSellerTableViewCell.swift
//  Baqala
//
...
import MapKit
class RegisterSellerTableViewCell: UITableViewCell {
       //MARK:- outlets
    ...
    fileprivate func loadLocalization() {
        ...
        let txtFields = [storeName, email, phone, address, password, passowrdConfirm] as [UITextField]
...
extension RegisterSellerTableViewCell : UITextFieldDelegate {
...
extension RegisterSellerTableViewCell: GMSPlacePickerViewControllerDelegate {
...
extension RegisterSellerTableViewCell: CLLocationManagerDelegate {
