//
//	RootPaymentModel.swift

import Foundation 
import ObjectMapper


class RootPaymentModel : NSObject, NSCoding, Mappable{
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? [PaymentDataModel]
